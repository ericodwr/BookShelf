...
function createActionDelete(idBook) {
  ...
  actionDelete.classList.add('deleteButton');
  actionDelete.innerHTML = '<p class="delete">Delete</p>';
...
function createActionRead(idBook) {
  ...
  action.classList.add('checkButton');
  action.innerHTML = '<p class="check">Done</p>';
...
function createActionUndo(idBook) {
  const action = document.createElement('button');
  action.classList.add('undoButton');
  action.innerHTML = '<p class="undo">Undo</p>';
